...
import com.kilogod.code.service.impl.UserServiceImpl;
...
public class InterceptorConfig implements WebMvcConfigurer, HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) {
        if ("OPTIONS".equals(request.getMethod()) || "/login".equals(request.getRequestURI())||
                "/banner/list".equals(request.getRequestURI())||
                "/adminlogin".equals(request.getRequestURI())||
                "/checkToken".equals(request.getRequestURI())||
                "/sms/sendSms".equals(request.getRequestURI())||
                "/sms/validateSms".equals(request.getRequestURI())||
                "/sms/sendSmsName".equals(request.getRequestURI())||
                "/user/register".equals(request.getRequestURI())||
                "/user/resetPwd".equals(request.getRequestURI())||
                "/file/upload".equals(request.getRequestURI())||
                "/agreement/list".equals(request.getRequestURI())||
                "/shopcategory/list".equals(request.getRequestURI())||
                "/goods/list".equals(request.getRequestURI())||
                "/payinfo/notifyUrl".equals(request.getRequestURI())||
                "/payinfo/returnUrl".equals(request.getRequestURI())||
                "/payinfo/payQuery".equals(request.getRequestURI())||
                "/payinfo/tradeClose".equals(request.getRequestURI())) {
            return true;
        }
        //1.判断入参是否携带token
        ...
        try {
            ...
            UserServiceImpl userService =(UserServiceImpl) BeanTool.getBean(IUserService.class);
